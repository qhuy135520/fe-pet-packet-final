...
export default function PetsDev() {
    ...
    return (
        <>
            ...
            <section className="blog-section spad">
                <div className="container">
                    <div className="text-right mb-2"> {/* Center and add margin-bottom */}
                        <button
                                                ...
                                                <div className="blog__item">
                                                    ...
                                                    <div className="blog__item__text">
                                                        <ul className="blog__item__tags">
                                                            <li>
                                                                <i className="fa fa-tags" /> {pet.petType.petTypeName}
                                                            </li>
                                                            {/* <li>Videos</li> */}
                                                        </ul>
                                                        <h5>
                                    ...
                                    <div className="form-group">
                                        ...
                                        <div className="custom-file">
                                            ...
                                            <label className="custom-file-label" htmlFor="petPicture">
                                                {newPet.petPicture ? newPet.petPicture.name : 'Choose file'}
                                            </label>
                                        </div>
                                    </div>
